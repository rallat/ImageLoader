...
import com.novoda.lib.imageloader.receiver.CacheCleaner.CacheCleanerUtil;
...
public class CacheCleanerTest {
	...
	@Test 
	public void shouldCleanOldFilesIfReduceCacheActionIsSet() throws IOException {
	...
	@Test 
	public void shouldNotCleanNewFilesWhitReduceAction() throws IOException {
		prepareTestFile();
		when(intent.hasExtra(CacheCleaner.EXPIRATION_PERIOD_EXTRA)).thenReturn(true);
		when(intent.getLongExtra(CacheCleaner.EXPIRATION_PERIOD_EXTRA, -1)).thenReturn(EXPIRATION_PERIOD);
	...
	@Test 
	public void shouldCleanUpFilesOnlyIfTheActionIsSet() throws IOException {
	...
	@Test 
	public void shouldCleanUpFilesOnlyIfTheCorrectActionIsSet() throws IOException {
		prepareTestFile(System.currentTimeMillis());
	...
	@Test 
	public void shouldCleanAllFilesIfCleanCacheActionIsSet() throws IOException {
		prepareTestFile();
	...
	@Test
	public void shouldReturnWithoutActionsIfCacheExtraDirIsNull() {
		prepareTestFile();
	...
	@Test
	public void shouldReturnWithoutActionsIfCacheDirExtraIsEmpty() {
		prepareTestFile();
	...
	@Test
	public void shouldReturnWithoutActionsIfCacheDirExtraIsNotSet() {
		prepareTestFile();
	...
	@Test 
	public void shouldNotCrashOnIntentNull() {	
		try {
